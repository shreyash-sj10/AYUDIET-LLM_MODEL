# Enhanced Graph Builder with Professional Architecture
# File: graph_builder_enhanced.py
...
from data_ingestion_enhanced import AyurvedicDataIngestion
...
if __name__ == "__main__":
    ...
    try:
        ...
        if app:
            ...
            print("\n✨ Ready to use with main_enhanced.py!")
        else:
